...
#define DSA2LV_BTN_RESET		IMX_GPIO_NR(4, 15)

#define SABRESD_HEADPHONE_DET	IMX_GPIO_NR(7, 8)
#define DSA2LV_PMIC_INT			IMX_GPIO_NR(7, 11)
#define DSA2LV_LED_R			IMX_GPIO_NR(7, 3)
#define DSA2LV_LED_B			IMX_GPIO_NR(7, 2)
#define DSA2LV_WIFI_DISABLE		IMX_GPIO_NR(7, 4)
...
#ifdef	CONFIG_DSA2LV
extern int mx6q_dsa2lv_init_wm8326(void);
#endif
...
static struct gpio_keys_button new_sabresd_buttons[] = {
	...
	GPIO_BUTTON(DSA2LV_BTN_POWER, KEY_POWER, 0, "power-key", 1, 1),
	GPIO_BUTTON(DSA2LV_BTN_RESET, KEY_VOLUMEDOWN, 1, "volume-down", 0, 1),
	// -> [J.Chiang], 2014/01/22 - Added for WOL
	GPIO_BUTTON(DSA2LV_WOL_IRQ, KEY_POWER, 1, "power-key-wol", 1, 1),
...
static void arch_poweroff(void)
{
	...
	gpio_request( DSA2LV_PMIC_GPIO_RST , "GPIO_RST" );
	gpio_direction_output( DSA2LV_PMIC_GPIO_RST , 1 );
	gpio_set_value( DSA2LV_PMIC_GPIO_RST , 0 );
	//msleep(100);//100ms
	//gpio_set_value( DSA2LV_PMIC_GPIO_RST , 1 );
...
// -> [Walker Chen], 2013/12/26 - DSA2LV board gpio init 
static inline void dsa2lv_init(void)
{
	// PMIC
	gpio_request( DSA2LV_PMIC_GPIO_RST , "GPIO_RST" );
	gpio_direction_output( DSA2LV_PMIC_GPIO_RST , 1 );
	...
	gpio_request( DSA2LV_PMIC_INT , "PMIC_INT" );
	...
	gpio_set_value( DSA2LV_LED_R , 0 );
	gpio_free( DSA2LV_LED_R );

	gpio_request( DSA2LV_LED_B , "LED_B" );
	gpio_direction_output( DSA2LV_LED_B , 1 );
	gpio_set_value( DSA2LV_LED_B , 1 );
	gpio_free( DSA2LV_LED_B );

	// WIFI disable
	gpio_request( DSA2LV_WIFI_DISABLE , "WIFI_DISABLE" );
	gpio_direction_output( DSA2LV_WIFI_DISABLE , 1 );
	gpio_set_value( DSA2LV_WIFI_DISABLE , 0 );
	gpio_free( DSA2LV_WIFI_DISABLE );

	// USB PWR_IN
	gpio_request( DSA2LV_USB_OTG_PWR_IN , "USB_OTG_PWR_IN" );
	gpio_direction_input( DSA2LV_USB_OTG_PWR_IN );
	gpio_free( DSA2LV_USB_OTG_PWR_IN );

	// board-id
	gpio_request( DSA2LV_BOARD_ID0 , "BOARD_ID0" );
	gpio_direction_input( DSA2LV_BOARD_ID0 );
	gpio_free( DSA2LV_BOARD_ID0 );

	gpio_request( DSA2LV_BOARD_ID1 , "BOARD_ID1" );
	gpio_direction_input( DSA2LV_BOARD_ID1 );
	gpio_free( DSA2LV_BOARD_ID1 );

	gpio_request( DSA2LV_BOARD_ID2 , "BOARD_ID2" );
	...
	gpio_free( DSA2LV_BTN_RESET );

	gpio_request( DSA2LV_BTN_POWER , "BTN_POWER" );
	...
	gpio_free( DSA2LV_LVDS_RES_0 );

	gpio_request( DSA2LV_LVDS_RES_1 , "DSA2LV_LVDS_RES_1" );
	gpio_direction_input( DSA2LV_LVDS_RES_1 );
	gpio_free( DSA2LV_LVDS_RES_1 );
	
	gpio_request( DSA2LV_LVDS_RES_2 , "DSA2LV_LVDS_RES_2" );
