...
#ifdef	CONFIG_DSA2LB
extern int mx6q_dsa2lb_init_wm8326(void);
#endif
...
static struct gpio_keys_button new_sabresd_buttons[] = {
	...
	GPIO_BUTTON(DSA2LB_BTN_POWER, KEY_POWER, 0, "power-key", 1, 1),
	GPIO_BUTTON(DSA2LB_BTN_RESET, KEY_VOLUMEDOWN, 1, "volume-down", 0, 1),
	// -> [J.Chiang], 2014/01/22 - Added for WOL
	GPIO_BUTTON(DSA2LB_WOL_IRQ, KEY_POWER, 1, "power-key-wol", 1, 1),
...
static void arch_poweroff(void)
{
	...
	gpio_request( DSA2LB_PMIC_GPIO_RST , "GPIO_RST" );
	gpio_direction_output( DSA2LB_PMIC_GPIO_RST , 1 );
	gpio_set_value( DSA2LB_PMIC_GPIO_RST , 0 );
	//msleep(100);//100ms
	//gpio_set_value( DSA2LB_PMIC_GPIO_RST , 1 );
...
// -> [Walker Chen], 2013/12/26 - DSA2LB board gpio init 
static inline void dsa2lb_init(void)
{
	// PMIC
	gpio_request( DSA2LB_PMIC_GPIO_RST , "GPIO_RST" );
	gpio_direction_output( DSA2LB_PMIC_GPIO_RST , 1 );
	...
	gpio_request( DSA2LB_PMIC_INT , "PMIC_INT" );
	...
	gpio_direction_output( DSA2LB_WIFI_DISABLE , 1 );
	gpio_set_value( DSA2LB_WIFI_DISABLE , 0 );
	gpio_free( DSA2LB_WIFI_DISABLE );
	...
	gpio_direction_input( DSA2LB_BOARD_ID0 );
	gpio_free( DSA2LB_BOARD_ID0 );

	gpio_request( DSA2LB_BOARD_ID1 , "BOARD_ID1" );
	gpio_direction_input( DSA2LB_BOARD_ID1 );
	gpio_free( DSA2LB_BOARD_ID1 );

	gpio_request( DSA2LB_BOARD_ID2 , "BOARD_ID2" );
	gpio_direction_input( DSA2LB_BOARD_ID2 );
	gpio_free( DSA2LB_BOARD_ID2 );

	// RTC
	gpio_request( DSA2LB_RTC_INT , "RTC_INT" );
	gpio_direction_input( DSA2LB_RTC_INT );
	gpio_free( DSA2LB_RTC_INT );

	// Btns
	gpio_request( DSA2LB_BTN_RESET , "BTN_RESET" );
	gpio_direction_input( DSA2LB_BTN_RESET );
	gpio_free( DSA2LB_BTN_RESET );
