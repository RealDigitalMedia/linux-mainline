...
/* ARM core */
#ifdef	CONFIG_DSA2LV
static struct regulator_consumer_supply dsa2lv_ldo1_consumers[] = {
	{
		.supply     = "DCVDD",
		.dev_name   = "0-001a",
	},
...
static struct regulator_consumer_supply dsa2lv_ldo7_consumers[] = {
	{
		.supply     = "MICVDD",
		.dev_name   = "0-001a",
	}
...
#else	// CONFIG_DSA2LV
#ifdef CONFIG_MX6_INTER_LDO_BYPASS
static struct regulator_consumer_supply dsa2lv_vddarm_consumers[] = {
	{
		.supply     = "VDDCORE_DCDC1",
	}
};

static struct regulator_consumer_supply dsa2lv_vddsoc_consumers[] = {
	{
		.supply     = "VDDSOC_DCDC2",
	}
};
...
static struct regulator_init_data dsa2lv_vddarm_dcdc1 = {
	.constraints = {
		.name = "vdd_arm",
		.min_uV = 100000,
		.max_uV = 1500000,
...
#ifdef CONFIG_MX6_INTER_LDO_BYPASS
	.num_consumer_supplies = ARRAY_SIZE(dsa2lv_vddarm_consumers),
	.consumer_supplies = dsa2lv_vddarm_consumers,
#endif
};


static struct regulator_init_data dsa2lv_vddsoc_dcdc2 = {
	.constraints = {
		.name = "vdd_soc",
		.min_uV = 100000,
		.max_uV = 1500000,
...
#ifdef CONFIG_MX6_INTER_LDO_BYPASS
	.num_consumer_supplies = ARRAY_SIZE(dsa2lv_vddsoc_consumers),
	.consumer_supplies = dsa2lv_vddsoc_consumers,
#endif
};


static struct regulator_init_data dsa2lv_vdd1v8_ldo1 = {
	.constraints = {
		.name = "vdd_1v8_ldo1",
		.min_uV = 1700000,
		.max_uV = 1800000,
	...
	.num_consumer_supplies = ARRAY_SIZE(dsa2lv_ldo1_consumers),
	.consumer_supplies = dsa2lv_ldo1_consumers,
};

static struct regulator_init_data dsa2lv_vdd2v5_ldo7 = {
	.constraints = {
		.name = "vdd_2v5_ldo7",
		.min_uV = 2400000,
		.max_uV = 2500000,
	...
	.num_consumer_supplies = ARRAY_SIZE(dsa2lv_ldo7_consumers),
	.consumer_supplies = dsa2lv_ldo7_consumers,
};
#endif	// CONFIG_REGULATOR

static struct wm831x_pdata dsa2lv_wm8326_pdata = {
#ifdef CONFIG_REGULATOR
	.dcdc = {
		&dsa2lv_vddarm_dcdc1,  /* DCDC1 */
		&dsa2lv_vddsoc_dcdc2,  /* DCDC2 */
		// -> [J.Chiang], 2014/01/03 - Added for other regulators
#ifdef	CONFIG_DSA2LV
		&dsa2lv_vdd1v8_ldo1,  /* LDO1 */
		&dsa2lv_vdd2v5_ldo7, /* LDO7 */
#endif	// CONFIG_DSA2LV
		// <- End.
	},
#endif
...
static struct i2c_board_info mxc_i2c2_board_info[] __initdata = {
	...
	.platform_data = &dsa2lv_wm8326_pdata,
	// -> [Walker Chen], 2013/12/18  - added pmic irq 
	.irq = gpio_to_irq( DSA2LV_PMIC_INT ),
	// <- End.
	},
};

int __init mx6q_dsa2lv_init_wm8326(void)
{
